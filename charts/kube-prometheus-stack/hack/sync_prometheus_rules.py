...
replacement_map = {
    ...
    'job="prometheus-k8s"': {
        ...
        'init': '{{- $prometheusJob := printf "%s" (include "kube-prometheus-stack.prometheus.fullname" .) }}'},
    'job="alertmanager-main"': {
        'replacement': 'job="{{ $alertmanagerJob }}"',
        'init': '{{- $alertmanagerJob := printf "%s" (include "kube-prometheus-stack.alertmanager.fullname" .) }}'},
